...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    NSArray *licenses = @[@"AFNetworking-License", @"AppSoundEngine-License", @"MBProgressHUD-License", @"HockeyApp-License", @"Appirater-License", @"Reachability-License", @"FXBlurView-License"];
