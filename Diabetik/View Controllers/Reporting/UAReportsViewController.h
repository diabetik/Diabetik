...
@class UAReportsViewController;
@protocol UAReportsDelegate <NSObject>
...
@class UADateButton;
@interface UAReportsViewController : UABaseViewController <UIScrollViewDelegate, UADatePickerDelegate>
