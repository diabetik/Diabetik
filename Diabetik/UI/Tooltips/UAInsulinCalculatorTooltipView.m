...
@interface UAInsulinCalculatorTooltipView ()
{
...
@implementation UAInsulinCalculatorTooltipView
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        header.text = NSLocalizedString(@"Insulin Calculator", nil);
        ...
        content.text = NSLocalizedString(@"The Insulin Calculator provides an estimate for correct insulin dosage. It is not a replacement for professional medical advice and should be used with caution.", nil);
