...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        UIView *topGradient = [[UIView alloc] initWithFrame:CGRectMake(0, 80.0f, self.frame.size.width-10.0f, 10.0f)];
        topGradient.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"CreditsGradientTop.png"]];
        [self addSubview:topGradient];
        
        UIView *bottomGradient = [[UIView alloc] initWithFrame:CGRectMake(0, self.frame.size.height-10.0f, self.frame.size.width-10.0f, 10.0f)];
